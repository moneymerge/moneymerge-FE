      ...
      <section className="bg-[#fffaed] dark:bg-gray-950 py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-2xl mx-auto text-center">
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight">캐릭터 상점</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <div className="bg-white dark:bg-gray-950 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">$14.99</p>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-950 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              <img
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">$24.99</p>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-950 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              <img
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">$16.99</p>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-950 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              <img
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">$21.99</p>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-950 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              <img
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">$18.99</p>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-950 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              <img
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">$22.99</p>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-950 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              <img
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">$27.99</p>
              </div>
            </div>
          </div>
        </div>
